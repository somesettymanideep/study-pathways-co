...
import { GraduationCap, BookOpen, Building2, Calendar, Coins, CheckCircle2, ArrowRight } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {universities.map((uni, i) => (
                <div key={i} className="bg-card rounded-xl p-5 border border-border shadow-card flex items-center gap-3">
